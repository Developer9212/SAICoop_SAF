...
@EnableJpaRepositories(entityManagerFactoryRef = "entityManagerFactory",transactionManagerRef = "transactionManager",basePackages = "com.saf_saicoop.dao")
public class SpringConfiguration {	
	...
	public LocalContainerEntityManagerFactoryBean entity(){
		...
		em.setPackagesToScan("com.saf_saicoop.entity");		
